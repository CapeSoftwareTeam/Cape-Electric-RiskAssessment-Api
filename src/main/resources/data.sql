...
-----------> STRUCTURE DETAILS <----------	
		   ...
		   CREATE TABLE structure_attributes_table(
			...
			CREATE TABLE riskprotection_table (
					...
					CONSTRAINT FK_CALCULATED_RISK_STRUCTURE_CHARACTERISTIC_ID FOREIGN KEY (STRUCTURE_CHARACTERISTIC_ID) REFERENCES structure_characterisics_table(STRUCTURE_CHARACTERISTIC_ID) ON DELETE CASCADE    
					);		 
