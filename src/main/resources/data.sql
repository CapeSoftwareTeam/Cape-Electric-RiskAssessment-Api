...
-----------> STRUCTURE DETAILS <----------	
		   ...
		   CREATE TABLE structure_attributes_table(
			...
			CREATE TABLE riskprotection_table (
				    ...
				    R_PRO_RB3 VARCHAR(255),
				    R_PRO_RV3 VARCHAR(255), 
				    R_PRO_RA4 VARCHAR(255),
				    R_PRO_RB4 VARCHAR(255),
				    R_PRO_RC4 VARCHAR(255),
				    R_PRO_RM4 VARCHAR(255),
				    R_PRO_RU4 VARCHAR(255),
				    R_PRO_RV4 VARCHAR(255),
				    R_PRO_RW4 VARCHAR(255),
				    R_PRO_RZ4 VARCHAR(255),
