	...
	public void printRiskAssessmentDataDetails(String userName, Integer riskId) throws RiskAssessmentException {
		...
		if (userName != null && !userName.isEmpty() && riskId != null && riskId != 0) {
			...
			try {
				...
				RiskDetailsCell.setFixedHeight(20f);
...
//				table7.setSpacingAfter(10f); // Space after table
				...
				PdfPCell cell69 = new PdfPCell(
						new Paragraph(structureCharacteristicsDetails.getYearPeoplePresentBuilding(), font10N));
...
//				table22.setSpacingAfter(10f); // Space after table
				...
				PdfPCell cell70 = new PdfPCell(new Paragraph("Type of floor surface :", font10N));
				// cell70.setBorder(PdfPCell.NO_BORDER);
				cell70.setGrayFill(0.92f);
				table22.addCell(cell70);
				PdfPCell cell72 = new PdfPCell(new Paragraph(structureAttributes.getStTypeOfFloorSurface(), font10N));
				cell72.setGrayFill(0.92f);
				// cell72.setBorder(PdfPCell.NO_BORDER);
				table22.addCell(cell72);

				PdfPCell cell73 = new PdfPCell(new Paragraph("Additional protection:", font10N));
				// cell73.setBorder(PdfPCell.NO_BORDER);
				table22.addCell(cell73);
				PdfPCell cell74 = new PdfPCell(new Paragraph(structureAttributes.getStAdditionalProtection(), font10N));
				// cell74.setBorder(PdfPCell.NO_BORDER);
				table22.addCell(cell74);

				PdfPCell cell75 = new PdfPCell(new Paragraph("Risk of fire:", font10N));
				cell75.setGrayFill(0.92f);
				// cell75.setBorder(PdfPCell.NO_BORDER);
				table22.addCell(cell75);
				PdfPCell cell76 = new PdfPCell(new Paragraph(structureAttributes.getStRiskOfFire(), font10N));
				cell76.setGrayFill(0.92f);
				// cell76.setBorder(PdfPCell.NO_BORDER);
				table22.addCell(cell76);

				PdfPCell cell78 = new PdfPCell(new Paragraph("Fire protection measures:", font10N));
				// cell78.setBorder(PdfPCell.NO_BORDER);
				table22.addCell(cell78);
				PdfPCell cell79 = new PdfPCell(new Paragraph(structureAttributes.getStFireProtectionMeasure(), font10N));
				// cell79.setBorder(PdfPCell.NO_BORDER);
				table22.addCell(cell79);

				PdfPCell cell80 = new PdfPCell(new Paragraph("Type of internal wiring:", font10N));
				cell80.setGrayFill(0.92f);
				// cell80.setBorder(PdfPCell.NO_BORDER);
				table22.addCell(cell80);
				PdfPCell cell81 = new PdfPCell(new Paragraph(structureAttributes.getStTypeOfInternalWiring(), font10N));
...
//				shieldCell.setBackgroundColor(new GrayColor(0.93f));
				...
				PdfPCell cell112 = new PdfPCell(new Paragraph("Total No. of lines:", font10N));
				// cell112.setBorder(PdfPCell.NO_BORDER);
				cell112.setGrayFill(0.92f);
				table4.addCell(cell112);
				PdfPCell cell113 = new PdfPCell(new Paragraph(structureAttributes.getTotalNoOfLines(), font10N));
				cell113.setGrayFill(0.92f);
				// cell113.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell113);

				PdfPCell cell114 = new PdfPCell(new Paragraph("Number of power lines:", font10N));
				// cell114.setBorder(PdfPCell.NO_BORDER);
				// cell114.setGrayFill(0.92f);
				table4.addCell(cell114);
				PdfPCell cell115 = new PdfPCell(new Paragraph(structureAttributes.getNoOfPowerLines(), font10N));
				// cell115.setGrayFill(0.92f);
				// cell115.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell115);

				PdfPCell cell110 = new PdfPCell(new Paragraph("Type of Power lines:", font10N));
				// cell110.setBorder(PdfPCell.NO_BORDER);
				cell110.setGrayFill(0.92f);
				table4.addCell(cell110);
				PdfPCell cell111 = new PdfPCell(new Paragraph(structureAttributes.getTypeOfPowerLines(), font10N));
				cell111.setGrayFill(0.92f);
				// cell111.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell111);

				PdfPCell cell116 = new PdfPCell(new Paragraph("Length of Power line :", font10N));
				// cell116.setBorder(PdfPCell.NO_BORDER);
				// cell116.setGrayFill(0.92f);
				table4.addCell(cell116);
				PdfPCell cell117 = new PdfPCell(new Paragraph(structureAttributes.getLengthOfPowerLines(), font10N));
				// cell117.setGrayFill(0.92f);
				// cell117.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell117);

				PdfPCell cell118 = new PdfPCell(new Paragraph("Shielding, grounding, isolation:", font10N));
				// cell118.setBorder(PdfPCell.NO_BORDER);
				cell118.setGrayFill(0.92f);
				table4.addCell(cell118);
				PdfPCell cell119 = new PdfPCell(
						new Paragraph(structureAttributes.getShieldingGroundingIsolation(), font10N));
				cell119.setGrayFill(0.92f);
				// cell119.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell119);

				PdfPCell cell200 = new PdfPCell(new Paragraph("Collection area of the Power lines:", font10N));
				// cell200.setBorder(PdfPCell.NO_BORDER);
				// cell200.setGrayFill(0.92f);
				table4.addCell(cell200);
				PdfPCell cell201 = new PdfPCell(new Paragraph(structureAttributes.getCollAreaOfPowerLines(), font10N));
				// cell201.setGrayFill(0.92f);
				// cell201.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell201);

				PdfPCell cell202 = new PdfPCell(new Paragraph("Collection area near the lines:", font10N));
				// cell202.setBorder(PdfPCell.NO_BORDER);
				cell202.setGrayFill(0.92f);
				table4.addCell(cell202);
				PdfPCell cell203 = new PdfPCell(new Paragraph(structureAttributes.getCollAreaOfNearLines(), font10N));
				cell203.setGrayFill(0.92f);
				// cell203.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell203);

				PdfPCell cell204 = new PdfPCell(new Paragraph("No. of dangerous event near the Power lines:", font10N));
				// cell204.setBorder(PdfPCell.NO_BORDER);
				// cell204.setGrayFill(0.92f);
				table4.addCell(cell204);
				PdfPCell cell205 = new PdfPCell(new Paragraph(structureAttributes.getEventNearThePowerLines(), font10N));
				// cell205.setGrayFill(0.92f);
				// cell205.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell205);

				PdfPCell cell206 = new PdfPCell(new Paragraph("No. of dangerous event on the Power lines:", font10N));
				// cell206.setBorder(PdfPCell.NO_BORDER);
				cell206.setGrayFill(0.92f);
				table4.addCell(cell206);
				PdfPCell cell207 = new PdfPCell(new Paragraph(structureAttributes.getEventOnThePowerLines(), font10N));
				cell207.setGrayFill(0.92f);
				// cell207.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell207);

				PdfPCell cell209 = new PdfPCell(new Paragraph("Number of telecommunication lines:", font10N));
				// cell209.setBorder(PdfPCell.NO_BORDER);
				// cell209.setGrayFill(0.92f);
				table4.addCell(cell209);
				PdfPCell cell300 = new PdfPCell(new Paragraph(structureAttributes.getNoOfTelecomLines(), font10N));
				// cell300.setGrayFill(0.92f);
				// cell300.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell300);

				PdfPCell cell301 = new PdfPCell(new Paragraph("Type of Telecom lines:", font10N));
				// cell301.setBorder(PdfPCell.NO_BORDER);
				cell301.setGrayFill(0.92f);
				table4.addCell(cell301);
				PdfPCell cell302 = new PdfPCell(new Paragraph(structureAttributes.getTypeOfTelecomLines(), font10N));
				cell302.setGrayFill(0.92f);
				// cell302.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell302);

				PdfPCell cell303 = new PdfPCell(new Paragraph("Length of Telecom line (In meters):", font10N));
				// cell303.setBorder(PdfPCell.NO_BORDER);
				// cell303.setGrayFill(0.92f);
				table4.addCell(cell303);
				PdfPCell cell304 = new PdfPCell(new Paragraph(structureAttributes.getLengthOfTelecomLines(), font10N));
				// cell304.setGrayFill(0.92f);
				// cell304.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell304);

				PdfPCell cell305 = new PdfPCell(new Paragraph("Shielding, grounding, isolation:", font10N));
				// cell305.setBorder(PdfPCell.NO_BORDER);
				cell305.setGrayFill(0.92f);
				table4.addCell(cell305);
				PdfPCell cell306 = new PdfPCell(
						new Paragraph(structureAttributes.getShieldingGroundingIsolationL1(), font10N));
				cell306.setGrayFill(0.92f);
				// cell306.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell306);

				PdfPCell cell307 = new PdfPCell(new Paragraph("Collection area of the Telecom lines:", font10N));
				// cell307.setBorder(PdfPCell.NO_BORDER);
				// cell307.setGrayFill(0.92f);
				table4.addCell(cell307);
				PdfPCell cell308 = new PdfPCell(new Paragraph(structureAttributes.getCollAreaOfTelecomLines(), font10N));
				// cell308.setGrayFill(0.92f);
				// cell308.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell308);

				PdfPCell cell309 = new PdfPCell(new Paragraph("Collection area near the Telecom lines:", font10N));
				// cell309.setBorder(PdfPCell.NO_BORDER);
				cell309.setGrayFill(0.92f);
				table4.addCell(cell309);
				PdfPCell cell310 = new PdfPCell(new Paragraph(structureAttributes.getCollNearOfTelecomLines(), font10N));
				cell310.setGrayFill(0.92f);
				// cell310.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell310);

				PdfPCell cell311 = new PdfPCell(new Paragraph("No. of dangerous event near the Telecom lines:", font10N));
				// cell311.setBorder(PdfPCell.NO_BORDER);
				// cell311.setGrayFill(0.92f);
				table4.addCell(cell311);
				PdfPCell cell312 = new PdfPCell(
						new Paragraph(structureAttributes.getEventNearTheTelecomeLines(), font10N));
				// cell312.setGrayFill(0.92f);
				// cell312.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell312);

				PdfPCell cell313 = new PdfPCell(new Paragraph("No. of dangerous event on the Telecom lines:", font10N));
				// cell313.setBorder(PdfPCell.NO_BORDER);
				cell313.setGrayFill(0.92f);
				table4.addCell(cell313);
				PdfPCell cell314 = new PdfPCell(new Paragraph(structureAttributes.getEventOnTheTelecomLines(), font10N));
...
//				table6.setSpacingAfter(10f); // Space after table
				...
				PdfPCell cell24 = new PdfPCell(new Paragraph("Hazard classification", font10N));
				// cell24.setBorder(PdfPCell.NO_BORDER);
				cell24.setGrayFill(0.92f);
				table6.addCell(cell24);
				PdfPCell cell25 = new PdfPCell(new Paragraph(losses.getHazardClassification(), font10N));
				cell25.setGrayFill(0.92f);
				// cell25.setBorder(PdfPCell.NO_BORDER);
				table6.addCell(cell25);

				PdfPCell cell132 = new PdfPCell(new Paragraph("Loss due to Physical damage:", font10N));
				// cell132.setBorder(PdfPCell.NO_BORDER);
				// cell132.setGrayFill(0.92f);
				table6.addCell(cell132);
				PdfPCell cell133 = new PdfPCell(new Paragraph(losses.getHumanLossOfphysicalDamage(), font10N));
				// cell133.setGrayFill(0.92f);
				// cell133.setBorder(PdfPCell.NO_BORDER);
				table6.addCell(cell133);

				PdfPCell cell134 = new PdfPCell(new Paragraph("Loss due to failure of internal system :", font10N));
				// cell134.setBorder(PdfPCell.NO_BORDER);
				cell134.setGrayFill(0.92f);
				table6.addCell(cell134);
				PdfPCell cell135 = new PdfPCell(new Paragraph(losses.getHumanLossOffailureOfInternalSystem(), font10N));
				cell135.setGrayFill(0.92f);
				// cell135.setBorder(PdfPCell.NO_BORDER);
				table6.addCell(cell135);

				PdfPCell cell136 = new PdfPCell(
						new Paragraph("Loss due to injury to living beings by electric shock:", font10N));
				// cell136.setBorder(PdfPCell.NO_BORDER);
				// cell136.setGrayFill(0.92f);
				table6.addCell(cell136);
				PdfPCell cell137 = new PdfPCell(new Paragraph(losses.getHumanLossOfInjuryOfElectricShock(), font10N));
				// cell137.setGrayFill(0.92f);
				// cell137.setBorder(PdfPCell.NO_BORDER);
				table6.addCell(cell137);

				PdfPCell cell1361 = new PdfPCell(new Paragraph("Loss due to physical damage:", font10N));
				// cell1361.setBorder(PdfPCell.NO_BORDER);
				cell1361.setGrayFill(0.92f);
				table6.addCell(cell1361);
				PdfPCell cell1371 = new PdfPCell(new Paragraph(losses.getHumanLossOfPhysicalDamageL1(), font10N));
				cell1371.setGrayFill(0.92f);
				// cell1371.setBorder(PdfPCell.NO_BORDER);
				table6.addCell(cell1371);

				PdfPCell cell1362 = new PdfPCell(new Paragraph("Loss due to failure of internal systems:", font10N));
				// cell1362.setBorder(PdfPCell.NO_BORDER);
				// cell1362.setGrayFill(0.92f);
				table6.addCell(cell1362);
				PdfPCell cell1373 = new PdfPCell(
						new Paragraph(losses.getHumanLossOffailureOfInternalSystemL1(), font10N));
...
//				table7.setSpacingAfter(10f); // Space after table
				...
				PdfPCell cell701 = new PdfPCell(new Paragraph("Loss due to Physical damage:", font10N));
				// cell701.setBorder(PdfPCell.NO_BORDER);
				cell701.setGrayFill(0.92f);
				table7.addCell(cell701);
				PdfPCell cell712 = new PdfPCell(new Paragraph(losses.getSerToPubPhysicalDamage(), font10N));
				cell712.setGrayFill(0.92f);
				// cell712.setBorder(PdfPCell.NO_BORDER);
				table7.addCell(cell712);

				PdfPCell cell713 = new PdfPCell(new Paragraph("Loss due to failure of internal system:", font10N));
				// cell713.setBorder(PdfPCell.NO_BORDER);
				// cell713.setGrayFill(0.92f);
				table7.addCell(cell713);
				PdfPCell cell432 = new PdfPCell(new Paragraph(losses.getSerToPubfailureOfInternalSystem(), font10N));
				// cell432.setGrayFill(0.92f);
				// cell432.setBorder(PdfPCell.NO_BORDER);
				table7.addCell(cell432);

				PdfPCell cell7012 = new PdfPCell(new Paragraph("Loss due to physical damage:", font10N));
				// cell7012.setBorder(PdfPCell.NO_BORDER);
				cell7012.setGrayFill(0.92f);
				table7.addCell(cell7012);
				PdfPCell cell7127 = new PdfPCell(new Paragraph(losses.getSerToPubPhysicalDamageL1(), font10N));
				cell7127.setGrayFill(0.92f);
				// cell7127.setBorder(PdfPCell.NO_BORDER);
				table7.addCell(cell7127);

				PdfPCell cell7013 = new PdfPCell(new Paragraph("Loss due to failure of internal systems:", font10N));
				// cell7013.setBorder(PdfPCell.NO_BORDER);
				// cell7013.setGrayFill(0.92f);
				table7.addCell(cell7013);
				PdfPCell cell7123 = new PdfPCell(new Paragraph(losses.getSerToPubfailureOfInternalSystemL1(), font10N));
...
//				table21.setSpacingAfter(10f); // Space after table
				...
				PdfPCell cell7018 = new PdfPCell(new Paragraph("Loss due to physical damage:", font10N));
				// cell7018.setBorder(PdfPCell.NO_BORDER);
				// cell7018.setGrayFill(0.92f);
				table21.addCell(cell7018);
				PdfPCell cell7129 = new PdfPCell(new Paragraph(losses.getCulHerOfPhysicalDamage(), font10N));
				// cell7129.setGrayFill(0.92f);
				// cell7129.setBorder(PdfPCell.NO_BORDER);
				table21.addCell(cell7129);

				PdfPCell cell728 = new PdfPCell(new Paragraph("Loss due to physical damage:", font10N));
				// cell728.setBorder(PdfPCell.NO_BORDER);
				cell728.setGrayFill(0.92f);
				table21.addCell(cell728);
				PdfPCell cell731 = new PdfPCell(new Paragraph(losses.getCulHerOfPhysicalDamageL1(), font10N));
...
//				tableData96.setBackgroundColor(new GrayColor(0.93f));
				tableData96.setFixedHeight(20f);
				table98.addCell(tableData96);
				document.add(table98);

				PdfPCell cell7281 = new PdfPCell(new Paragraph("Loss due to physical damage:", font10N));
				// cell7281.setBorder(PdfPCell.NO_BORDER);
				cell7281.setGrayFill(0.92f);
				table19.addCell(cell7281);
				PdfPCell cell7321 = new PdfPCell(new Paragraph(losses.getEcoLossOfPhysicalDamage(), font10N));
				cell7321.setGrayFill(0.92f);
				// cell7321.setBorder(PdfPCell.NO_BORDER);
				table19.addCell(cell7321);

				PdfPCell cell72813 = new PdfPCell(new Paragraph("Loss due to failure of internal system:", font10N));
				// cell72813.setBorder(PdfPCell.NO_BORDER);
				// cell72813.setGrayFill(0.92f);
				table19.addCell(cell72813);
				PdfPCell cell73214 = new PdfPCell(new Paragraph(losses.getEcoLossOfFailureOfInternalSystem(), font10N));
				// cell73214.setGrayFill(0.92f);
				// cell73214.setBorder(PdfPCell.NO_BORDER);
				table19.addCell(cell73214);

				PdfPCell cell7283 = new PdfPCell(
						new Paragraph("Loss due to injury to living beings by electric:", font10N));
				// cell7283.setBorder(PdfPCell.NO_BORDER);
				cell7283.setGrayFill(0.92f);
				table19.addCell(cell7283);
				PdfPCell cell732 = new PdfPCell(new Paragraph(losses.getEcoLossOfInjuryOfElectricShock(), font10N));
				cell732.setGrayFill(0.92f);
				// cell732.setBorder(PdfPCell.NO_BORDER);
				table19.addCell(cell732);

				PdfPCell cell729 = new PdfPCell(new Paragraph("Loss due to physical damage:", font10N));
				// cell729.setBorder(PdfPCell.NO_BORDER);
				// cell729.setGrayFill(0.92f);
				table19.addCell(cell729);
				PdfPCell cell7320 = new PdfPCell(new Paragraph(losses.getEcoLossOfPhysicalDamageL1(), font10N));
				// cell7320.setGrayFill(0.92f);
				// cell7320.setBorder(PdfPCell.NO_BORDER);
				table19.addCell(cell7320);

				PdfPCell cell72835 = new PdfPCell(new Paragraph("Loss due to failure of internal systems:", font10N));
				// cell72835.setBorder(PdfPCell.NO_BORDER);
				cell72835.setGrayFill(0.92f);
				table19.addCell(cell72835);
				PdfPCell cell73212 = new PdfPCell(new Paragraph(losses.getEcoLossOfFailureOfInternalSystemL1(), font10N));
