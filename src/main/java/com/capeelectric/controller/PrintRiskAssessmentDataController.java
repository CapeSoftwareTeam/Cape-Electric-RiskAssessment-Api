...
public class PrintRiskAssessmentDataController {
	...
	@GetMapping("/printRiskCustomerDetails/{userName}/{riskId}")
	...
	@GetMapping("/printRiskAssessmentDataDetails/{userName}/{riskId}")
	...
	@GetMapping("/printRiskAssessmentFinalPDF/{userName}/{riskId}/{projectName}")
